...
exports.validateRegister = [
  ...
  body('role')
    .optional()
    .isIn(['student']).withMessage(
      'Self-registration only allows the student role. Contact admin for staff accounts.'
    ),
...
exports.validateCreateStaff = [
  ...
  body('role')
    ...
    .isIn(['health_officer', 'professor', 'admin'])
    .withMessage('Invalid role. Must be health_officer, professor, or admin.'),
  body('courses')
    .optional()
    .isArray().withMessage('Courses must be an array of course codes.'),
];
...
exports.validateCreateRequest = [
  ...
  body('reason')
    ...
    .withMessage('Invalid reason. Must be one of: illness, medical_procedure, mental_health, emergency, other.'),
...
exports.validateSearchQuery = [
  ...
  query('startDate')
    .optional()
    .isISO8601().withMessage('Invalid startDate format.').toDate(),

  query('endDate')
    .optional()
    .isISO8601().withMessage('Invalid endDate format.').toDate(),
];