...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (Array.isArray(serverErrors) && serverErrors.length > 0) {
        ...
        setErrors(mapped);
        const step1Fields = ['firstName', 'lastName', 'email', 'studentId'];
  ...
  const inputClass = (field) =>
    `w-full px-4 py-2.5 border rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white
     ...
     dark:border-gray-600 transition-colors ${errors[field] ? 'border-red-400' : 'border-gray-300 dark:border-gray-600'}`;
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" value={formData.firstName}
                    onChange={set('firstName')} placeholder="Juan"
                ...
                <div>
                  ...
                  <input type="text" value={formData.lastName}
                    onChange={set('lastName')} placeholder="Dela Cruz"
              ...
              <div>
                ...
                <input type="email" value={formData.email}
                  onChange={set('email')} placeholder="you@university.edu"
              ...
              <div>
                ...
                <input type="text" value={formData.studentId}
                  onChange={set('studentId')} placeholder="2024-00001"
